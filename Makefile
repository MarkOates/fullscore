...
TRANSFORM_OBJS=double_duration_transform erase_note_transform half_duration_transform retrograde_transform insert_note_transform invert_transform toggle_rest_transform transpose_transform
