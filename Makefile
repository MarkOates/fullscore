...
OBJS=action_queue command_bar fullscore_application_controller gui_score_editor main mixer music_engraver playback_control playback_device_interface run_script
