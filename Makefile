...
bin/tests/measure_grid_helper_test$(EXE_EXTENSION): tests/measure_grid_helper_test.cpp obj/helpers/measure_grid_helper.o obj/models/measure_grid.o obj/models/time_signature.o obj/models/note.o obj/helpers/duration_helper.o obj/models/note_playback_info.o
	g++ obj/models/note_playback_info.o obj/models/measure_grid.o obj/helpers/duration_helper.o obj/models/note.o obj/models/time_signature.o obj/helpers/measure_grid_helper.o -o bin/tests/measure_grid_helper_test tests/measure_grid_helper_test.cpp -I./include -I$(GOOGLE_TEST_INCLUDE_DIR) -I$(ALLEGRO_INCLUDE_DIR) -I$(ALLEGROFLARE_DIR) -L$(GOOGLE_TEST_LIB_DIR) $(GOOGLE_TEST_LIBS)
