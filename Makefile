...
obj/%.o: src/%.cpp
	...
	@g++ -c -std=c++17 -Wall -Wuninitialized -Weffc++ $< -o $@ -I$(ALLEGRO_FLARE_DIR)/include -I$(ALLEGRO_DIR)/include -I./include
...
obj/tests/%.o: tests/%.cpp $(OBJECTS)
	...
	@g++ -c -std=c++17 -Wall -Wuninitialized -Weffc++ $< -o $@ -I$(ALLEGRO_FLARE_DIR)/include -I$(ALLEGRO_DIR)/include -I./include -I$(GOOGLE_TEST_INCLUDE_DIR)
	@echo "done. Object at \033[1m\033[32m$@\033[0m"
...
obj/test_runner.o: test_runner.cpp
	@mkdir -p $(@D)
	@printf "compiling test obj file \e[1m\e[36m$<\033[0m..."
	@g++ -c -std=c++17 -Wall -Wuninitialized -Weffc++ $< -o $@ -I$(GOOGLE_TEST_INCLUDE_DIR)
	@echo "done. Object at \033[1m\033[32m$@\033[0m"
...
bin/tests/%: obj/tests/%.o obj/test_runner.o
	...
	@g++ -std=c++17 -Wall -Wuninitialized -Weffc++ $(OBJECTS) $< obj/test_runner.o -o $@ -l$(ALLEGRO_FLARE_LIB) $(ALLEGRO_LIBS_FOR_TESTS) $(GOOGLE_TEST_LIBS) -L$(ALLEGRO_FLARE_DIR)/lib -L$(ALLEGRO_DIR)/lib $(OPENGL_LIB) -I$(ALLEGRO_FLARE_DIR)/include -I$(ALLEGRO_DIR)/include -I./include -I$(GOOGLE_TEST_INCLUDE_DIR) -L$(GOOGLE_TEST_LIB_DIR)
	@echo "done. Executable at \033[1m\033[32m$@\033[0m"
...
bin/test_runner: test_runner.cpp $(TEST_OBJECTS)
	...
	@g++ -std=c++17 -Wall -Wuninitialized -Weffc++ $(OBJECTS) $(TEST_OBJECTS) $< -o $@ -l$(ALLEGRO_FLARE_LIB) $(ALLEGRO_LIBS_FOR_TESTS) $(GOOGLE_TEST_LIBS) -L$(ALLEGRO_FLARE_DIR)/lib -L$(ALLEGRO_DIR)/lib $(OPENGL_LIB) -I$(ALLEGRO_FLARE_DIR)/include -I$(ALLEGRO_DIR)/include -I./include -I$(GOOGLE_TEST_INCLUDE_DIR) -L$(GOOGLE_TEST_LIB_DIR)
	@echo "done. Executable at \033[1m\033[32m$@\033[0m"
