...
OBJS+=actions/action_base actions/move_cursor_down_action actions/move_cursor_left_action actions/move_cursor_right_action actions/move_cursor_up_action actions/toggle_command_bar_action actions/toggle_playback_action
