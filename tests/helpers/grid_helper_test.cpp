...
TEST(GridDimensionsHelperTest, returns_the_length_to_the_measure_of_4_4_measures)
{
   ...
   EXPECT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 9), 9.0);
}
...
TEST(GridDimensionsHelperTest, returns_the_length_to_the_measure_with_non_4_4_time_signatures)
{
   ...
   ASSERT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 1), 0.75);
   ASSERT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 2), 2.0);
   ASSERT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 3), 2.75);
   ASSERT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 4), 3.0625); // + 0.3125
   ASSERT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 5), 5.5625); // + 2.5
   ASSERT_EQ(GridDimensionsHelper::get_length_to_measure(grid, 6), 6.6875); // + 1.125
}
...
TEST(GridDimensionsHelperTest, can_get_the_width_of_a_grid)
{
   ...
   ASSERT_EQ(4.375, GridDimensionsHelper::get_width(grid));
}
...
TEST(GridDimensionsHelperTest, can_get_its_height_up_to_a_staff)
{
   ...
   ASSERT_EQ(0.0, GridDimensionsHelper::get_height_to_staff(grid, 0));
   ASSERT_EQ(1.0, GridDimensionsHelper::get_height_to_staff(grid, 1));
   ASSERT_EQ(1.5, GridDimensionsHelper::get_height_to_staff(grid, 2));
   ASSERT_EQ(2.5, GridDimensionsHelper::get_height_to_staff(grid, 3));
   ASSERT_EQ(3.0, GridDimensionsHelper::get_height_to_staff(grid, 4));
}
...
TEST(GridDimensionsHelperTest, can_get_height_of_a_staff)
{
   ...
   ASSERT_EQ(1.0, GridDimensionsHelper::get_height_of_staff(grid, 0));
   ASSERT_EQ(0.5, GridDimensionsHelper::get_height_of_staff(grid, 1));
   ASSERT_EQ(1.0, GridDimensionsHelper::get_height_of_staff(grid, 2));
   ASSERT_EQ(0.5, GridDimensionsHelper::get_height_of_staff(grid, 3));
   ASSERT_EQ(0.5, GridDimensionsHelper::get_height_of_staff(grid, 4));
}
