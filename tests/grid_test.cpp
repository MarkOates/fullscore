...
TEST(MeasureGridTest, returns_true_if_coordinates_are_within_the_grid)
{
   MeasureGrid grid(17, 13);
...
TEST(MeasureGridTest, returns_false_if_coordinates_are_outside_the_grid)
{
   MeasureGrid grid(17, 13);
...
TEST(MeasureGridTest, when_attempting_to_delete_a_measure_lt_zero_or_gte_num_measures__returns_false_and_does_nothing_to_the_score)
{
   ...
   MeasureGrid grid(num_columns_to_test, 1);
