...
float MeasureGridHelper::get_length_to_measure(const MeasureGrid &grid, int measure_index)
{
...
float MeasureGridHelper::get_width(const MeasureGrid &grid)
{
   float length = 0;
...
float MeasureGridHelper::get_height_to_staff(const MeasureGrid &grid, int staff_index)
{
...
float MeasureGridHelper::get_height_of_staff(MeasureGrid &grid, int staff_index) // TODO make const
{
